...
@interface ZHG_LastDefault_VC ()

@end

@implementation ZHG_LastDefault_VC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cell_ID = @"ZHG_LastDefaultDate_VC_Cell";
    ...
    switch (indexPath.row) {
        case 0:
            cell.textLabel.text = @"先设置最小，再设置默认";
            break;
        case 1:
            cell.textLabel.text = @"先设置最大，再设置默认";
            break;
        case 2:
            cell.textLabel.text = @"先设置最小，再最大，再设置默认";
            break;
        case 3:
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0: {
            ...
            //设置默认日期，就不考虑当前日期的影响，只是在确定数据源的时候会加入当前时间来判断
            
            datePickerView.minDate = [NSDate dateFromString:@"2015-03-02 12:00" formatter:@"yyyy-MM-dd HH:mm"];
            datePickerView.defaultDate = [NSDate dateFromString:@"2034-03-31 12:00" formatter:@"yyyy-MM-dd HH:mm"];
        ...
        case 3: {
            ...
            datePickerView.maxDate = [NSDate dateFromString:@"2034-03-31 12:06" formatter:@"yyyy-MM-dd HH:mm"];
            datePickerView.minDate = [NSDate dateFromString:@"2015-03-02 12:40" formatter:@"yyyy-MM-dd HH:mm"];
            datePickerView.defaultDate = [NSDate dateFromString:@"2018-03-23 12:05" formatter:@"yyyy-MM-dd HH:mm"];
            [datePickerView show];
        }
            break;
